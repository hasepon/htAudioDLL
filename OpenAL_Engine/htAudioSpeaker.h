...
extern "C"
{
	UNITY_INTERFACE_EXPORT int UNITY_INTERFACE_API htaSpeakerCreate(wchar_t* filepath, wchar_t* soundname, wchar_t* material);
	UNITY_INTERFACE_EXPORT int UNITY_INTERFACE_API htaSpeakerCreateID(wchar_t* filepath, uint16_t id);
	UNITY_INTERFACE_EXPORT int UNITY_INTERFACE_API htaSpeakerCreateName(wchar_t* filepath, wchar_t* soundname);
